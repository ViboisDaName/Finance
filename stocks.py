...
date_picker_from = DatePicker(title="Start Date", value="2023-01-01", min_date="2000-01-01",
                            max_date=dt.datetime.now().strftime("%Y-%M-%D"))
date_picker_to = DatePicker(title="Start Date", value="2023-02-01", min_date="2000-01-01",
                            max_date=dt.datetime.now().strftime("%Y-%M-%D"))

indicator_choice = MultiChoice(options=["100 Day SMA, 30 Day SMA, Linear Progression"])
